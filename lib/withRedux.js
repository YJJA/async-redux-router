...
function withRedux() {
  ...
  return function (Component) {
    ...
    WithReduxWrapper.dispatchInitialAction = function (_ref) {
      ...
      var state = defaultMapToProps(store.getState());
      var actions = mapDispatchToProps(dispatch);
      var dispatchInitialAction = Component.dispatchInitialAction || Component.getInitialProps || _noop3.default;
      return Promise.all([dispatchInitialAction(_extends({}, actions, state, { location: location, query: query }))]).then(function (_ref2) {
