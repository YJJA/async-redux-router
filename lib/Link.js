...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // https://github.com/ReactTraining/react-router/blob/master/packages/react-router-dom/modules/Link.js
  ...
  function Link() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Link.__proto__ || Object.getPrototypeOf(Link)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
      ...
      !isModifiedEvent(event) // ignore clicks with modifier keys
          ...
          var history = _this.props.router.history;
  ...
  _createClass(Link, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['replace', 'to', 'router', 'dispatch']); // eslint-disable-line no-unused-vars

      var href = router.history.createHref(typeof to === 'string' ? { pathname: to } : to);
