  ...
  (0, _createClass3.default)(Link, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          to = _props.to,
          props = (0, _objectWithoutProperties3.default)(_props, ['replace', 'to']); // eslint-disable-line no-unused-vars

      var href = this.context.router.history.createHref(typeof to === 'string' ? { pathname: to } : to);

      return _react2.default.createElement('a', (0, _extends3.default)({}, props, { onClick: this.handleClick, href: href }));
    }
  }]);
  return Link;
